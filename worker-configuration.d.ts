/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4360751dd2fb5e48c62d94951e44db7c)
// Runtime types generated with workerd@1.20250730.0 2025-05-06 enable_nodejs_http_modules,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		RSS_FEED_WORKER_KV: KVNamespace;
		DISCORD_WEBHOOK_URL_SCIENCE: string;
		DISCORD_WEBHOOK_URL_IT: string;
		ENABLE_HTTP_REQUEST: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_WEBHOOK_URL_SCIENCE" | "DISCORD_WEBHOOK_URL_IT" | "ENABLE_HTTP_REQUEST">> {}
}
